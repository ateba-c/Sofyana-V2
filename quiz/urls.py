...
urlpatterns = [
    ...
    path('search/run/',                                views.search_run,             name='search_run'),
    ...
    path('parent/create-child/',                      views.parent_create_child_view, name='parent_create_child'),
    path('parent/set-child-grade/',                   views.parent_set_child_grade_view, name='parent_set_child_grade'),
